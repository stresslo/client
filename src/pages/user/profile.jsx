...
const Profile = () => {
    ...
    return (
        <div className='page' style={{flexDirection: 'column', gap : '10px'}}>
            <Topback/>
            <LazyLoadImage loading='lazy' effect='blur' onClick={() => inputref.current.click()} src={(file) ? URL.createObjectURL(file) : context.img} width={150} height={150} style={{borderRadius : '50%', objectFit: 'cover', border: '1px solid var(--text)', cursor : 'pointer'}}/>
