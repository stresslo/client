        ...
        <div className='filter-box'>
            ...
            <div style={{width: '100%', height: 'max-content', marginTop: '20px'}}>
                ...
                <div style={{display: 'flex', flexWrap: 'wrap', gap: '10px', padding: '15px 0px', paddingBottom: '35px'}}>
                    <div className="button" style={ pricing === 'all' ? {borderRadius: '5px', width: '90px', height:  '0' , padding: '20px 0',boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--primary)'} : {borderRadius: '10px', width: '90px', height: '0', padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--prime)', color : '#aaa'}} onClick={() => {setPricing('all'); price !== 0 && setPrice(0); setOptprice('all')}}>All</div>
                    <div className="button" style={ pricing === 'paid' ? {borderRadius: '5px', width: '90px', height: '0' ,padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--primary)'} : {borderRadius: '10px', width: '90px', height: '0', padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--prime)', color : '#aaa'}} onClick={() => {setPricing('paid'); setPrice(10000); setOptprice('under')}}>Paid</div>
                    <div className="button" style={ pricing === 'free' ? {borderRadius: '5px', width: '90px', height: '0' ,padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--primary)'} : {borderRadius: '10px', width: '90px', height: '0', padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--prime)', color : '#aaa'}} onClick={() => {setPricing('free'); price !== 0 && setPrice(0); setOptprice('all')}}>Free</div>
                </div>
                {(pricing === 'paid') && (
                    <>
                ...
                <div style={{display: 'flex', flexWrap: 'wrap', gap: '10px', padding: '15px 0'}}>
                    <div className="button" style={ optprice === 'under' ? {borderRadius: '5px', width: '90px', height: '0',padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--primary)'} : {borderRadius: '10px', width: '90px', height: '0', padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--prime)', color : '#aaa'}} onClick={() => {setOptprice('under')}}>Under</div>
                    <div className="button" style={ optprice === 'above' ? {borderRadius: '5px', width: '90px', height: '0',padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--primary)'} : {borderRadius: '10px', width: '90px', height: '0', padding: '20px 0', boxShadow: 'unset', backgroundColor: 'var(--prime)', color : '#aaa'}} onClick={() => {setOptprice('above')}}>Above</div>
                </div>
