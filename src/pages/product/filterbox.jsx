    ...
    return (
        <div className='filter-box'>
            ...
            <div style={{width: '100%', height: 'max-content', marginTop: '20px'}}>
                ...
                <div style={{display: 'flex', flexWrap: 'wrap', gap: '10px', padding: '15px 0px', paddingBottom: '35px'}}>
                    <div className="button" style={ tech === 'all' ? {borderRadius: '10px', width: 'max-content', padding: '15px 20px', height: '0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--text)'} : {borderRadius: '10px', width: 'max-content', height: '0', padding: '15px 20px', boxShadow: 'unset', backgroundColor: '#aaa', color : '#ccc'}} onClick={() => setTech('all')}>All</div>
                    <div className="button" style={ tech === 'react' ? {borderRadius: '10px', width: 'max-content', padding: '15px 20px', height: '0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--text)'} : {borderRadius: '10px', width: 'max-content', height: '0', padding: '15px 20px', boxShadow: 'unset', backgroundColor: '#aaa', color : '#ccc'}} onClick={() => setTech('react')}>React JS</div>
                    <div className="button" style={ tech === 'angular' ? {borderRadius: '10px', width: 'max-content', padding: '15px 20px', height: '0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--text)'} : {borderRadius: '10px', width: 'max-content', height: '0', padding: '15px 20px', boxShadow: 'unset', backgroundColor: '#aaa', color : '#ccc'}} onClick={() => setTech('angular')}>Angular JS</div>
                    <div className="button" style={ tech === 'html' ? {borderRadius: '10px', width: 'max-content', padding: '15px 20px', height: '0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--text)'} : {borderRadius: '10px', width: 'max-content', height: '0', padding: '15px 20px', boxShadow: 'unset', backgroundColor: '#aaa', color : '#ccc'}} onClick={() => setTech('html')}>HTML & CSS</div>
                    <div className="button" style={ tech === 'vue' ? {borderRadius: '10px', width: 'max-content', padding: '15px 20px', height: '0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--text)'} : {borderRadius: '10px', width: 'max-content', height: '0', padding: '15px 20px', boxShadow: 'unset', backgroundColor: '#aaa', color : '#ccc'}} onClick={() => setTech('vue')}>Vue JS</div>
                    <div className="button" style={ tech === 'svelte' ? {borderRadius: '10px', width: 'max-content', padding: '15px 20px', height: '0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--text)'} : {borderRadius: '10px', width: 'max-content', height: '0', padding: '15px 20px', boxShadow: 'unset', backgroundColor: '#aaa', color : '#ccc'}} onClick={() => setTech('svelte')}>Svelte JS</div>
                    <div className="button" style={ tech === 'next' ? {borderRadius: '10px', width: 'max-content', padding: '15px 20px', height: '0', boxShadow: 'unset', backgroundColor: 'var(--yellow)', color : 'var(--text)'} : {borderRadius: '10px', width: 'max-content', height: '0', padding: '15px 20px', boxShadow: 'unset', backgroundColor: '#aaa', color : '#ccc'}} onClick={() => setTech('next')}>Next JS</div>
                </div>
                </>}
