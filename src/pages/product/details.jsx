...
const Details = () => {
    ...
    return (
        <div className='page-max'>
            <div className="back" ref={backref} onClick={() => i ? i.prev ? navigate(i.prev, { state: { ...i, prev: `/product/${i.ctg}` } }) : navigate(`/product/${i.ctg}`, { state: i.pageHistory}) : navigate(`/product/${i.ctg}`, { state: i.pageHistory })}>
            ...
            <div className="form">
                <div className='prev-form' style={{ marginTop: '10px', paddingBottom: '0', gap: '20px' }}>
                    <div className='itext'>Product Details</div>
                        ...
                        <div onClick={() => navigate(`/contributor/profile/${i.by}`, { state: { ...i, prev : location.pathname } })} className='product-card' style={{ height: 'max-content', width: '100%', marginTop: '20px', cursor: 'pointer', borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px' }}>
                            <div className='wrapped-text'>
                                <div className='wrapped-details' style={{margin: 0, paddingTop: '0', display: 'flex',alignItems: 'unset', flexDirection: "column", gap: '10px'}}>
