            ...
            <div className="form">
                <div className='prev-form' style={{ marginTop: '10px', paddingBottom: '0', gap: '20px' }}>
                    <div className='itext'>Product Details</div>
                        ...
                        <div onClick={() => navigate(`/contributor/profile/${i.by}`, { state: { ...i, prev : location.pathname } })} className='product-card' style={{ height: 'max-content', width: '100%', marginTop: '10px', cursor: 'pointer', borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px' }}>
                            <div className='wrapped-text'>
                                <div className='wrapped-details' style={{margin: 0, paddingTop: '0', display: 'flex',alignItems: 'unset', flexDirection: "column", gap: '10px'}}>
