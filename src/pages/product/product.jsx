                ...
                <div id='control' className='form' style={{margin: 'auto'}}>
                    <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '15px'}}>
                        <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                            <div className='button' style={{height: '35px', backgroundColor: 'var(--primary)'}} onClick={() => { document.querySelector('.filter-box').classList.add('show') || document.querySelector('.filter-box').classList.remove('show') }}>
